...
export const CpuChipIcon: React.FC<{ className?: string }> = ({ className }) => ( // System Log
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-6 h-6 ${className}`}>
    <path d="M11.25 3v-1.5a.75.75 0 0 1 .75-.75h.75a.75.75 0 0 1 0 1.5h-.75V3h1.5v-1.5A.75.75 0 0 1 15 .75h.75a.75.75 0 0 1 0 1.5h-.75V3h1.5a.75.75 0 0 1 .75.75v1.5h1.5a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-1.5 0v-.75h-1.5v1.5h1.5a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-1.5 0v-.75h-1.5v1.5a.75.75 0 0 1 .75.75h1.5a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-1.5 0V15h-1.5v1.5h1.5a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-1.5 0v-.75h-1.5v1.5a.75.75 0 0 1 .75.75h.75a.75.75 0 0 1 0 1.5h-.75a.75.75 0 0 1-.75-.75V21h-1.5v1.5a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1 0-1.5h.75V21h-1.5v1.5a.75.75 0 0 1-.75.75h-.75a.75.75 0 0 1 0-1.5h.75V21h-1.5a.75.75 0 0 1-.75-.75v-1.5H3.75a.75.75 0 0 1-.75-.75v-.75a.75.75 0 0 1 1.5 0v.75h1.5v-1.5H3.75a.75.75 0 0 1-.75-.75v-.75a.75.75 0 0 1 1.5 0v.75h1.5v-1.5a.75.75 0 0 1-.75-.75H3.75a.75.75 0 0 1-.75-.75v-.75a.75.75 0 0 1 1.5 0V9h1.5V7.5H3.75a.75.75 0 0 1-.75-.75V6a.75.75 0 0 1 .75-.75h1.5V3.75a.75.75 0 0 1 .75-.75H6v-1.5A.75.75 0 0 1 6.75.75h.75a.75.75 0 0 1 0 1.5H6.75V3h1.5V1.5A.75.75 0 0 1 9 .75h.75a.75.75 0 0 1 0 1.5H9V3h2.25Z" />
    <path fillRule="evenodd" d="M8.25 7.5V6h7.5v1.5h1.5V6a1.5 1.5 0 0 0-1.5-1.5h-7.5A1.5 1.5 0 0 0 6.75 6v1.5h1.5Zm-1.5 9H6V9h1.5v7.5Zm9-7.5H18V9h-1.5v6H18V9h-1.5Zm-6 7.5v1.5h-1.5V18h1.5v-1.5h-1.5V15h7.5v1.5h-1.5V18h1.5v-1.5A1.5 1.5 0 0 0 18 15h-1.5v-6H18V7.5h1.5V9a1.5 1.5 0 0 1-1.5 1.5h-1.5v6H15a1.5 1.5 0 0 0 1.5-1.5v-1.5h-1.5v-6h-6v6H7.5v1.5H9A1.5 1.5 0 0 1 7.5 15v1.5h1.5v-6h6v6H9V15h-.75Z" clipRule="evenodd" />
  </svg>
);

export const MagicWandIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-6 h-6 ${className}`}>
    <path fillRule="evenodd" d="M3.75 2.25a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75h1.5a.75.75 0 0 0 .75-.75V3a.75.75 0 0 0-.75-.75H3.75Zm9.75 0a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75h1.5a.75.75 0 0 0 .75-.75V3a.75.75 0 0 0-.75-.75h-1.5Zm-4.5 9a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75h1.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75h-1.5Zm9.75 0a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75h1.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75h-1.5Zm-9.398 2.28a.75.75 0 0 0-1.06 0l-1.97 1.97a.75.75 0 1 0 1.06 1.06l1.97-1.97a.75.75 0 0 0 0-1.06Zm4.586-4.586a.75.75 0 0 0-1.06 0l-1.97 1.97a.75.75 0 0 0 1.06 1.06l1.97-1.97a.75.75 0 0 0 0-1.06ZM17.25 4.5a.75.75 0 0 0-1.5 0v1.5c0 .414.336.75.75.75h1.5a.75.75 0 0 0 .75-.75V5.25a.75.75 0 0 0-.75-.75h-1.5Z" clipRule="evenodd" />
    <path d="M4.125 7.5a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5h-1.5ZM8.25 4.125a.75.75 0 0 0-1.5 0h1.5a.75.75 0 0 0 0-1.5v1.5ZM4.125 12a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5h-1.5Zm-.75 4.125a.75.75 0 0 0 1.5 0v-1.5a.75.75 0 0 0-1.5 0v1.5Zm12.02-9.495a.75.75 0 0 0-1.06 0L8.283 12.182a.75.75 0 1 0 1.06 1.06l6.062-6.062a.75.75 0 0 0 0-1.06ZM16.125 12a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5h-1.5Zm-4.5-7.875a.75.75 0 0 0-1.5 0h1.5a.75.75 0 0 0 0-1.5v1.5ZM12 16.125a.75.75 0 0 0-1.5 0v1.5a.75.75 0 0 0 1.5 0v-1.5Z" />
  </svg>
);
