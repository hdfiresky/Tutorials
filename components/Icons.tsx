...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className }) => ( // Agent 0 - Query Analyzer
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-6 h-6 ${className}`}>
      <path d="M12.98 2.524a1.5 1.5 0 0 0-1.96 0L2.524 11.02a1.5 1.5 0 0 0 .98 2.628l.262.033V20.25a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-6.568l.262-.033a1.5 1.5 0 0 0 .98-2.628L12.98 2.524ZM12 15.75a1.5 1.5 0 0 1-1.5-1.5V12a1.5 1.5 0 0 1 3 0v2.25a1.5 1.5 0 0 1-1.5 1.5Z" />
      <path d="M11.25 10.5a.75.75 0 0 0 1.5 0v-2.25a.75.75 0 0 0-1.5 0V10.5Z" />
    </svg>
);
