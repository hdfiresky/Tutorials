...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-6 h-6 ${className}`}>
    <path fillRule="evenodd" d="M12.964 2.274a.75.75 0 0 1 .536 1.286l-2.25 3.75a.75.75 0 0 1-1.286-.536l2.25-3.75a.75.75 0 0 1 .75-.75ZM18 9.75a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H18.75a.75.75 0 0 1-.75-.75ZM18.685 15.15a.75.75 0 0 0 .536-1.286l-2.25-3.75a.75.75 0 1 0-1.286.536l2.25 3.75a.75.75 0 0 0 .75.75ZM6.75 12a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H7.5a.75.75 0 0 1-.75-.75Z" clipRule="evenodd" />
    <path d="M5.618 3.332a.75.75 0 0 1 .536 1.286l-2.25 3.75a.75.75 0 0 1-1.286-.536l2.25-3.75a.75.75 0 0 1 .75-.75Zm11.09 7.5a.75.75 0 0 0-.75.75v2.25a.75.75 0 0 0 1.5 0v-2.25a.75.75 0 0 0-.75-.75Zm-7.5-3.375a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H9.958a.75.75 0 0 1-.75-.75Zm.75 12.375a.75.75 0 0 0-.75.75v2.25a.75.75 0 0 0 1.5 0v-2.25a.75.75 0 0 0-.75-.75Z" />
  </svg>
);
